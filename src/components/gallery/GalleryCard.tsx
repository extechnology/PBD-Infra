          ...
          {galleryData?.map((segment, index) => (
            ...
            >
                ...
                {(() => {
                  ...
                  return mainImg ? (
                    <img
                      src={mainImg}
                      alt={segment.title}
                      className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-transform duration-1500 group-hover:scale-105"
                    />
                  ) : null;
                })()}
              ...
              <div className="flex flex-col grow p-8 items-center text-center bg-white/5 group-hover:bg-white/10 transition-colors duration-300">
                <h3 className="text-[15px] font-heading font-semibold mb-6 tracking-widest uppercase text-black/90 group-hover:text-sand transition-colors border-b border-white/10 pb-4 w-full">
                  {segment.title}
                </h3>
                ...
                >
                  <button className="w-full py-4 border border-white/20 hover:border-sand hover:bg-sand hover:text-charcoal bg-black/20 text-black group-hover:text-sand font-heading uppercase tracking-widest text-xs font-bold transition-all duration-300 shadow-sm">
                    View Now!
                  </button>
                </Link>
              </div>
