        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-zinc-400 text-md leading-9 mb-10 max-w-2xl">
              ...
              <br />
              <br />
              With a strong commitment to quality construction, timely delivery,
              and customer satisfaction, PBD continues to build lasting
              relationships and deliver developments that create long-term
